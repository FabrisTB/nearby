...
+ (GNCPayload2 *)fromCpp:(Payload)payload {
  ...
  switch (payload.GetType()) {
    case location::nearby::connections::PayloadType::kBytes: {
      ...
      return [[GNCBytesPayload2 alloc] initWithData:payloadData identifier:payloadId];
    }
...
@implementation GNCBytesPayload2
...
@implementation GNCStreamPayload2
...
@implementation GNCFilePayload2
